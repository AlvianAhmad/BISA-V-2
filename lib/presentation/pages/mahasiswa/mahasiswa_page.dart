  ...
  Widget build(BuildContext context) {
    return CustomScrollView(
      ...
      slivers: [
        ...
        // ✅ CALENDER DI BAWAH CARD (mengisi area kosong)
        SliverToBoxAdapter(
          child: Padding(
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
      ...
      builder: (context, snap) {
        ...
        final nama = (data['nama'] ?? user?.displayName ?? 'Mahasiswa')
            .toString();
        final npm = (data['npm'] ?? data['nim'] ?? '').toString();
        final prodi = (data['prodi'] ?? data['programStudi'] ?? '').toString();

        final subtitleParts = <String>[];
        if (npm.trim().isNotEmpty) subtitleParts.add('NPM: $npm');
        if (prodi.trim().isNotEmpty) subtitleParts.add(prodi);
...
// =====================
class _MahasiswaInfoCardBlue extends StatelessWidget {
  const _MahasiswaInfoCardBlue();

  static const Color _a = Color(0xFF1B3C9E);
  static const Color _b = Color(0xFF0E2E72);
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
      ...
      builder: (context, snap) {
        ...
        final nama = (data['nama'] ?? user.displayName ?? '-').toString();
        final npm = (data['npm'] ?? data['nim'] ?? '-').toString();
        final prodi = (data['prodi'] ?? data['programStudi'] ?? '-').toString();
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Wrap(
                            ...
                            runSpacing: 10,
                            children: [
                              _BluePill(label: 'NPM', value: npm),
                              _BluePill(label: 'Prodi', value: prodi),
                            ],
                          ),
                        ],
                      ),
...
class _BluePill extends StatelessWidget {
  ...
  const _BluePill({required this.label, required this.value});
...
// =====================
// ✅ CALENDER CARD (tanpa package tambahan) - pakai CalendarDatePicker
// =====================
...
class _CalendarCardState extends State<_CalendarCard> {
  ...
  static const Color _brand = Color(0xFF1B3C9E);
  static const Color _ink = Color(0xFF1A2552);
  ...
  Widget build(BuildContext context) {
    ...
    final headerText =
        '${_dayName(_selected.weekday)}, ${_two(_selected.day)} ${_monthName(_selected.month)} ${_selected.year}';
      ...
      child: ClipRRect(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              decoration: BoxDecoration(color: _brand.withOpacity(0.06)),
              child: Stack(
                children: [
                  Positioned(
                    right: -40,
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      '${_two(_selected.day)}/${_two(_selected.month)}/${_selected.year}',
                      style: const TextStyle(
                        fontWeight: FontWeight.w800,
                        color: _muted,
                        fontSize: 12.5,
                    ...
                    child: SizedBox(
                      ...
                      child: TextButton(
                        ...
                        style: TextButton.styleFrom(
                          backgroundColor: _brand.withOpacity(0.10),
                          foregroundColor: _brand,
                          disabledForegroundColor: _brand.withOpacity(0.35),
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(14),
                            side: BorderSide(color: _brand.withOpacity(0.18)),
                          ),
                        ),
                        child: const Text(
                          'Hari ini',
            ...
            Padding(
              ...
              child: Theme(
                data: Theme.of(context).copyWith(
                  ...
                  // kecilin splash biar lebih smooth
                  splashColor: _brand.withOpacity(0.10),
