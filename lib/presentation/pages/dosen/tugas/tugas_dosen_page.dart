        ...
        return _ActionSheet(
          ...
          onLihatPengumpulan: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (_) => PengumpulanTugasPage(
                  tugasId: tugas.id,
          ...
          onEdit: () async {
            ...
            if (ok == true && context.mounted) {
              _showTopToast(context, message: 'Tugas berhasil diperbarui');
            }
          },
          ...
          onDelete: () async {
            ...
            if (ok == true) {
              if (context.mounted) {
                _showTopToast(context, message: 'Tugas berhasil dihapus');
              }
              vm.hapusTugas(tugas.id);
            }
          },
        );
      },
...
class _ActionSheet extends StatelessWidget {
  ...
  // ✅ TAMBAH CALLBACK INI
  final VoidCallback onLihatPengumpulan;
  ...
  const _ActionSheet({
    ...
    required this.onLihatPengumpulan,
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                title: const Text(
                  'Lihat Pengumpulan Mahasiswa',
                  style: TextStyle(fontWeight: FontWeight.w800),
                ),
                onTap: onLihatPengumpulan,
              ),
