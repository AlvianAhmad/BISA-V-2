// lib/presentation/pages/dosen/absensi/tambah_absensi_page.dart
...
class TambahAbsensiPage
  ...
  State<
    TambahAbsensiPage
  >
  createState() => _TambahAbsensiPageState();
}

class _TambahAbsensiPageState
    extends
        State<
          TambahAbsensiPage
        > {
  ...
  _save(
    ...
    try {
      ...
      _showTopToast(
        context,
        message: 'Sesi absensi berhasil ditambahkan',
      );
      Navigator.pop(
        context,
        true,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const _SectionTitle(
                                ...
                                title: 'Detail Sesi',
                                caption: 'Lengkapi informasi sesi absensi.',
                              ),
                              const SizedBox(
                                height: 16,
                              ),
                              ...
                              const _SectionTitle(
                                ...
                                title: 'Waktu',
                                caption: 'Pilih tanggal dan jam sesi.',
                              ),
                              const SizedBox(
                                height: 14,
                              ),
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: !hasAny
                ? Text(
                    'Preview akan muncul setelah kamu mengisi judul, kelas, dan jam.',
                    style: TextStyle(
                      fontSize: 12.5,
                      height: 1.35,
                      fontWeight: FontWeight.w700,
